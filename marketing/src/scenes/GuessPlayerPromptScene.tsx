/******************************************************************************
 * GuessPlayerPromptScene.tsx - Landscape
 * =============================================================================
...
export const GuessPlayerPromptScene: React.FC<Props> = ({title, subtitle}) => {
    ...
    <AbsoluteFill style={{backgroundColor: "#020617", overflow: "hidden"}}>
      ...
      <AbsoluteFill style={{alignItems: "center", justifyContent: "center", textAlign: "center"}}>
        <div style={{opacity: textOpacity, transform: `scale(${scale})`, fontFamily: "Bebas Neue", color: "white"}}>
          <div style={{fontSize: 96, letterSpacing: 5, textShadow: "0 0 30px rgba(96,165,250,0.78)", textTransform: "uppercase"}}>{title}</div>
