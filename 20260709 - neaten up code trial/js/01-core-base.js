/* ============================================================
   01-core-base.js
   CORE BASE: constants, Firebase config, player loading, base game flow, rendering, initial online/local setup
...
/* ============================================================
   QUICK EDIT GUIDE - CORE SETTINGS

   Main game constants are near the top:
   - DECLINES_ALLOWED
   - AUCTION_BUDGET
   - BID_SKIPS_ALLOWED
   - TEAM_SHAPE

   Firebase config is also near the top.
   ============================================================ */
