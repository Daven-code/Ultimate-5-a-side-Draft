...
function injectStyles(){
  ...
  style.textContent = `
    ...
    .game-entry-panel{max-width:980px;margin:28px auto}.game-entry-heading{text-align:center;color:#fff;margin-bottom:18px}.game-entry-heading h2{font-size:clamp(1.9rem,4vw,2.8rem);margin:0 0 8px}.game-entry-heading p{margin:0;color:#dbeafe;font-weight:900}
